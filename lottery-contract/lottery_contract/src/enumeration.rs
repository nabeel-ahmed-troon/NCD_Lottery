...
impl Lottery{
    ...
    pub fn get_lottery_owner(&self)->AccountId{
        let res= &self.owner;
        log!("Owner of Lottery System is : {}",res);
        res.clone()
    }

    pub fn get_winner_of_lottery(&self)->AccountId{
        log!("Winner of this Lottery is : {}",self.winner);
        self.winner.clone()
    }
